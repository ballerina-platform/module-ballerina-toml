function validTOMLDataGen() returns map<[string, boolean, json]> {
    return {
        ...
        "basic float": ["somekey = 3.14", false, {somekey: 3.14}],
        "float with 0 after decimal": ["somekey = 1.0", false, {somekey: 1.0}],
        "negative float": ["somekey = -1.0", false, {somekey: -1.0}],
        "float with underscore": ["somekey = 123_456.123_456", false, {somekey: 123456.123456}],
        ...
        "zero float": ["somekey = 0.0", false, {somekey: 0.0}],
        "zero exponential float": ["somekey = 0e0", false, {somekey: 0.0}],
        "two zero exponential float": ["somekey = 0e00", false, {somekey: 0.0}],
        "positive float exponential": ["somekey = 5e+2", false, {somekey: 500.0}],
        "negative float exponential": ["somekey = -2E-2", false, {somekey: -0.02}],
        ...
        "array with different values": ["arr = [1, 's', true, [1, 2], 1.0]", false, {arr: [1, "s", true, [1, 2], 1.0]}],
        "array for multiple lines": ["array_multi", true, {arr: [1, "s", true, [1, 2], 1.0]}],
